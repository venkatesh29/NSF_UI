...
import pageObjects.JSON_Mapping_pageObjects;
	...
	public class Step_ExportResultsLayoutandFunctionality{
		static WebDriver driver;
		public static Sheet JSheet, MSheet;
		public Step_ExportResultsLayoutandFunctionality() {
...
//			Utils.waitForPageToLoad(driver);
//			Header.ClinicalSetup_link(driver).click();
//			if(IndivisdualPage.ClinicalSearchScreen(driver).isDisplayed()){
...
//	public void user_should_select_atleast_one_record_by_clicking_on_checkbox() throws Throwable {
//		try {
//			driver.findElement(byname("selecting one record"))
//			utils.waitforpageToLoad(driver);
//			Header.ClinicalSetup_link(driver).click();
//			if (Individualpage.Clinicalsearchscreen()
//			
//			
//		}
//			
